...
- [Python fundamentals](./python_fundamentals.ipynb) — types, math, conditionals, loops, lists, tuples, dictionaries.
- [Functions and classes](./functions_classes.ipynb) — defining functions, namespaces, and reading classes.
