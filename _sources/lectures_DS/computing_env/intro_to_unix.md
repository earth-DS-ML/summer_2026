...
`jovyan` is our **username** and `jupyter-dhruvbalwada` is the **hostname**.
...
let's have a look at how the file system as a whole is organized.  After this
